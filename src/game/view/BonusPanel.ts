    ...
    private onTouch(e: egret.TouchEvent): void
    {
        ...
        egret.Tween.get(this.groupIcon).to({scaleX: 1.5, scaleY: 1.5}, 350, egret.Ease.elasticOut).call(function (): void
        {
            ...
            switch (this.awardId)
            {
                ...
                //         toY = 98;
                //     }
                //     egret.Tween.get(this.groupIcon).to({x: toX, y: toY, alpha: 0.4,scaleX: 1, scaleY: 1}, 350).call(function (): void
                //     {
                //         this.hidePanel();
                //
                //     }, this);
                //     break;
                //
                // case BonusType.Relic_1:
                // case BonusType.Relic_2:
                // case BonusType.Relic_3:
                // case BonusType.Relic_4:
                //     toX = 400;
                //     toY = 750;
                //     egret.Tween.get(this.groupIcon).to({x: toX, y: toY, alpha: 0.4,scaleX: 1, scaleY: 1}, 350).call(function (): void
                //     {
